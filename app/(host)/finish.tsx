  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.stepContainer}>
        ...
        <TouchableOpacity onPress={() => { /* Handle Continue action */router.navigate('./(hostupload)/uploadimage' )}} style={[defaultStyles.btn, {width: 150}]}>
      ...
      <View style={styles.stepContainer}>
        ...
        <Text style={[styles.stepTitle, { color: '#ccc' }]}>Finish up</Text>
        <Text style={[styles.stepDescription, { color: '#ccc' }]}>
